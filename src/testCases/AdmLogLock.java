...
public class AdmLogLock {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		FileReader file = new FileReader("C:/Users/girish/Desktop/selenium1/input1.txt");
		...
		while((line=br.readLine()) != null){
			...
			if (count >= 1){
			    ...
			    if ((iteration == 4) && (ErrorMessage.contains("Error: The maximum number of login attempts has been reached. Please try again in 5 minutes."))){
			    	System.out.println(iteration + " Maximum invalid attempts are over: PASSED");
			    } else if (ErrorMessage.contains("Error: The maximum number of login attempts has been reached. Please try again in 5 minutes.")){
			    	System.out.println(iteration + " Maximum invalid attempts are over: DONE");
			    } else {
			    	System.out.println(iteration + " Maximum invalid attempts are not over: FAILED");
			    }
